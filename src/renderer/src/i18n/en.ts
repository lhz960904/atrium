...
export const en: typeof zh = {
  ...
  tool: {
    verb: {
      ...
      schedule: 'Scheduled',
      cancel: 'Cancelled',
      computerListApps: 'Listed apps',
      computerInspect: 'Inspected',
      computerClick: 'Clicked',
      computerType: 'Typed',
      computerKey: 'Pressed',
      computerScroll: 'Scrolled',
      computerDrag: 'Dragged',
      computerSet: 'Set value',
      computerAction: 'Acted on',
    },
    verbActive: {
      read: 'Reading',
      write: 'Writing',
      ...
      schedule: 'Scheduling',
      cancel: 'Cancelling',
      computerListApps: 'Listing apps',
      computerInspect: 'Inspecting',
      computerClick: 'Clicking',
      computerType: 'Typing',
      computerKey: 'Pressing',
      computerScroll: 'Scrolling',
      computerDrag: 'Dragging',
      computerSet: 'Setting value',
      computerAction: 'Acting on',
    },
    type: {
      file: 'File · {{path}}',
  ...
  settings: {
    ...
    computer: {
      ...
      dragHeading: 'Drag “{{app}}” into the list above to grant “{{perm}}”',
      dragName: 'Atrium',
      dragLabel: 'Drag',
      dragClose: 'Later',
    ...
    providers: {
      ...
      custom: {
        ...
        added: 'Added',
        id: 'Model ID',
        idHint: 'Exactly as the endpoint expects',
        name: 'Display name',
        api: 'Request format',
        contextWindow: 'Context window',
        contextWindowHint: 'Input and output together, as the vendor publishes it.',
