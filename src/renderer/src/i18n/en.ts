...
export const en: typeof zh = {
  ...
  settings: {
    ...
    browser: {
      ...
      tokenWaiting: 'Waiting for the copied token…',
      tokenHint: 'On the page that just opened, click Copy — we detect it automatically.',
      tokenSkip: 'Skip and just approve in the browser',
